        ...
        <div className="mt-6 flex flex-1 flex-col items-center justify-between">
          ...
          <div className="flex flex-col items-center gap-5 pb-1">
            ...
            <button
              ...
              title="Help"
              className="flex flex-col items-center gap-2 text-sm font-medium text-white/90 hover:text-white"
            >
              <span className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-white text-lg font-semibold">
                ?
              </span>
              Help
            </button>
