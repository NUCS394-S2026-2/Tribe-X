...
| Architecture guide | feedforward | inferential | `/docs/agent/architecture.md` | Architecture / Design Guild
 |
| Design guide | feedforward | inferential | `/docs/agent/design.md` |  Design Guild |
| Testing guide | feedforward | inferential | `/docs/agent/testing.md` | Development Practices Guild
 |
| Data model guide | feedforward | inferential | `/docs/agent/data-model.md` |  Design Guild |
| Story spec requirement | feedforward | inferential | `/docs/agent/stories/` | Customer Interaction Guild
 |
...
|---|---|---|
| Sprint 0 | Initial harness setup for AI-assisted music metadata generation workflow | Added architecture, testing, metadata taxonomy, and validation controls |