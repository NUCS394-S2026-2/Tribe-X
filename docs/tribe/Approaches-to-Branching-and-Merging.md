...
- What is the process for merging?
  Create PR and two people designated to review all PRs
- Will your tribe use pull requests?
  Yes
- What are the naming conventions for branches and commits?
  Branches should be named relevant to the change, commits should be named have a naming convention of "TYPE: brief description". Type can be feat, fix, style, refactor, and test
...
For naming commits and pull requests, consider using the [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) specification or a simplified version of it.
